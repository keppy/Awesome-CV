  ...
  \cventry
    ...
    {March 2024 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Founded KeppyLab, focusing on open source AI projects and consulting}
        \item {Created WorldEnder.ai, a text-adventure game with multiple LLMs as the backend--allowing for a more dynamic, engaging experience}
